...
/// REGRESSION GUARD — t17_07: SQL UPDATE embedding rewrites recall (a downstream reindex API surface).
#[test]
fn t17_07_update_embedding_via_sql_recall_returns_new_vector() {
    ...
    // SQL UPDATE — the path a downstream reindex API actually issues.
