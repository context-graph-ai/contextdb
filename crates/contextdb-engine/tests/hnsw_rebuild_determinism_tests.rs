...
const REOPEN_ROWS: usize = 1000;
const TOP_K: usize = 50;
const IN_PROCESS_REBUILD_ATTEMPTS: usize = 1;
const PARALLEL_PRESSURE_ATTEMPTS: usize = 1;
const PARALLEL_PRESSURE_WORKERS: usize = 2;
const REPEAT_REOPEN_ITERATIONS: usize = 1;
...
fn with_parallel_pressure(run: impl FnOnce() + std::panic::UnwindSafe) {
    ...
    let worker_count = num_cpus::get().clamp(2, PARALLEL_PRESSURE_WORKERS);
...
#[test]
#[serial(hnsw_rebuild_determinism)]
