//! Trigger-throughput Criterion bench. Asserts P99 wall-clock budgets
...
fn collect_p99(register_trigger: bool, writers: usize, commits_per_writer: usize) -> Duration {
    ...
    if register_trigger {
        ...
        // Deterministic RED warmup excluded from measured samples. The
        // typed-error path returns Err to the probes; the wait-and-proceed
        // path waits and proceeds, then the normal
